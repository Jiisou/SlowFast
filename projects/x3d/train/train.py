...
def train(
    ...
    Args:
        ...
        train_cfg: Training configuration.
        binary: If True, use binary classification (Normal vs Abnormal).
    """
    # Setup
...
def main():
    ...
    # Update save name for binary classification
    save_name = args.save_name
    if args.binary:
        save_name = f"{save_name}_binary"
    ...
    print(f"Classification: {'Binary (Normal vs Abnormal)' if args.binary else 'Multi-class'}")
    ...
    # Train
    train(model_cfg, data_cfg, train_cfg, binary=args.binary)
